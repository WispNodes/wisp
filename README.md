...
Run WISP from your browser — no terminal. **[Download the latest release](https://github.com/WispNodes/wisp/releases/latest)**, unzip it, then in `chrome://extensions` enable Developer mode and **Load unpacked** the folder. Enter your wallet and click Start. (Chrome Web Store listing is in review.)

Source is in [`extension/`](extension).
